...
## Low-level concepts {#low-levelconcepts}
...
## High-level concepts {#high-levelconcepts}
...
### `OverridablesPlugin` (low level) {#overridables-pluginlowlevel}
...
### `ContainerPlugin` (low level) {#container-pluginlowlevel}
...
### `ContainerReferencePlugin` (low level) {#container-reference-pluginlowlevel}
...
### `ModuleFederationPlugin` (high level) {#module-federation-pluginhighlevel}
...
### Separate builds per page {#separatebuildsperpage}
...
### Components library as container {#componentslibraryascontainer}
