...
## Creating a Plugin {#creatinga-plugin}
...
## Basic plugin architecture {#basicpluginarchitecture}
...
## Compiler and Compilation {#compilerand-compilation}
...
## Async event hooks {#asynceventhooks}
...
### Configuration defaults {#configurationdefaults}
