...
### Commons chunk for entries {#commonschunkforentries}
...
### Explicit vendor chunk {#explicitvendorchunk}
...
### Move common modules into the parent chunk {#movecommonmodulesintotheparentchunk}
...
### Extra async commons chunk {#extraasynccommonschunk}
...
### Passing the `minChunks` property a function {#passingthemin-chunkspropertyafunction}
...
## Combining implicit common vendor chunks and manifest file {#combiningimplicitcommonvendorchunksandmanifestfile}
