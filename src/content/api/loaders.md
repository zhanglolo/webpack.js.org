...
### `this.rootContext` {#thisroot-context}
...
### `this.getOptions(schema)` {#thisget-optionsschema}
...
### `this.loaderIndex` {#thisloader-index}
...
### `this.resourcePath` {#thisresource-path}
...
### `this.resourceQuery` {#thisresource-query}
...
### `this.emitWarning` {#thisemit-warning}
...
### `this.loadModule` {#thisload-module}
...
### `this.addDependency` {#thisadd-dependency}
...
### `this.addContextDependency` {#thisadd-context-dependency}
...
### `this.clearDependencies` {#thisclear-dependencies}
...
## Deprecated context properties {#deprecatedcontextproperties}
...
### `this.inputValue` {#thisinput-value}
...
### Inline matchResource {#inlinematch-resource}
