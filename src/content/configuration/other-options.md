...
### `cache.cacheDirectory` {#cachecache-directory}
...
### `cache.cacheLocation` {#cachecache-location}
...
### `cache.buildDependencies` {#cachebuild-dependencies}
...
### `cache.managedPaths` {#cachemanaged-paths}
...
### `cache.hashAlgorithm` {#cachehash-algorithm}
...
### `cache.idleTimeout` {#cacheidle-timeout}
...
### `cache.idleTimeoutForInitialStore` {#cacheidle-timeout-for-initial-store}
...
## `recordsInputPath` {#records-input-path}
...
## `recordsOutputPath` {#records-output-path}
...
#### infrastructureLogging.level {#infrastructure-logginglevel}
...
#### infrastructureLogging.debug {#infrastructure-loggingdebug}
