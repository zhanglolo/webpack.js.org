...
### `stats.assetsSort` {#statsassets-sort}
...
### `stats.moduleAssets` {#statsmodule-assets}
...
### `stats.cachedAssets` {#statscached-assets}
...
### `stats.chunkGroups` {#statschunk-groups}
...
### `stats.chunkModules` {#statschunk-modules}
...
### `stats.chunkRootModules` {#statschunk-root-modules}
...
### `stats.chunkOrigins` {#statschunk-origins}
...
### `stats.chunksSort` {#statschunks-sort}
...
### `stats.orphanModules` {#statsorphan-modules}
...
### `stats.errorDetails` {#statserror-details}
...
### `stats.errorStack` {#statserror-stack}
...
### `stats.excludeAssets` {#statsexclude-assets}
...
### `stats.excludeModules` {#statsexclude-modules}
...
### `stats.loggingDebug` {#statslogging-debug}
...
### `stats.loggingTrace` {#statslogging-trace}
...
### `stats.maxModules` {#statsmax-modules}
...
### `stats.modulesSort` {#statsmodules-sort}
...
### `stats.moduleTrace` {#statsmodule-trace}
...
### `stats.outputPath` {#statsoutput-path}
...
### `stats.providedExports` {#statsprovided-exports}
...
### `stats.publicPath` {#statspublic-path}
...
### `stats.usedExports` {#statsused-exports}
...
### `stats.warningsFilter` {#statswarnings-filter}
...
### `stats.chunkRelations` {#statschunk-relations}
...
### Extending stats behaviours {#extendingstatsbehaviours}
