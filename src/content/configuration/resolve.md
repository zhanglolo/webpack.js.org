...
### `resolve.aliasFields` {#resolvealias-fields}
...
### `resolve.cacheWithContext` {#resolvecache-with-context}
...
### `resolve.descriptionFiles` {#resolvedescription-files}
...
### `resolve.enforceExtension` {#resolveenforce-extension}
...
### `resolve.enforceModuleExtension` {#resolveenforce-module-extension}
...
### `resolve.mainFields` {#resolvemain-fields}
...
### `resolve.mainFiles` {#resolvemain-files}
...
### `resolve.unsafeCache` {#resolveunsafe-cache}
...
### `resolve.cachePredicate` {#resolvecache-predicate}
...
### `resolveLoader.moduleExtensions` {#resolve-loadermodule-extensions}
