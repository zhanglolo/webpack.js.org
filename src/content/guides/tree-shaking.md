...
=======
## Mark the file as side-effect-free {#markthefileasside-effect-free}
>>>>>>> en-master
...
=======
## Clarifying tree shaking and `sideEffects` {#clarifyingtreeshakingandside-effects}
>>>>>>> en-master
...
## 将函数调用标记为无副作用
=======
## Mark a function call as side-effect-free {#markafunctioncallasside-effect-free}
>>>>>>> en-master
...
## 压缩输出结果
=======
## Minify the Output {#minifythe-output}
>>>>>>> en-master
